...
import {CLIENT_ID,CALLBACK} from "../renderer/_shared/constants/config";
...
function init() {
    ...
    const p = path.join(__dirname, '..', 'renderer'); // eslint-disable-line


    mainWindow.loadURL(`file://${p}/app.html`);
